...
constexpr std::size_t maximum_frame_size =
    sample_u32_be_prefix_size + maximum_record_size;
...
inline constexpr ntl::wfp::stream_callout_key<stream_layer_v4> stream_callout_key_v4{
    GUID{0x9668c244,
         0xb861,
         0x4b9c,
...
inline constexpr ntl::wfp::stream_callout_key<stream_layer_v6> stream_callout_key_v6{
    GUID{0xc1cb79c8,
         0x825c,
         0x42cf,
