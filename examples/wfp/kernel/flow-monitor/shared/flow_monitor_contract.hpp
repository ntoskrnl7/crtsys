...
inline constexpr wchar_t service_name[] = L"crtsys_wfp_flow_monitor";
inline constexpr wchar_t device_name[] = L"CrtSysWfpFlowMonitor";
inline constexpr wchar_t user_device_path[] = L"\\\\.\\CrtSysWfpFlowMonitor";
...
inline constexpr ntl::wfp::inspection_callout_key<flow_layer_v4> flow_callout_key_v4{
    GUID{0xd2295c99,
         0x1253,
         0x40eb,
...
inline constexpr ntl::wfp::inspection_callout_key<stream_layer_v4> stream_callout_key_v4{
    GUID{0x78ab1b5b,
         0x4979,
         0x4fe7,
...
// {A61ADAF8-2C50-44C3-ABDF-E251D9C3EB1B}
inline constexpr ntl::wfp::inspection_callout_key<flow_layer_v6> flow_callout_key_v6{
    GUID{0xa61adaf8,
         0x2c50,
         0x44c3,
         {0xab, 0xdf, 0xe2, 0x51, 0xd9, 0xc3, 0xeb, 0x1b}}};

// {20A29D4A-112B-4819-9768-EE598DF5CA4B}
inline constexpr ntl::wfp::inspection_callout_key<stream_layer_v6> stream_callout_key_v6{
    GUID{0x20a29d4a,
         0x112b,
         0x4819,
         {0x97, 0x68, 0xee, 0x59, 0x8d, 0xf5, 0xca, 0x4b}}};

// {AFC389E2-B315-488D-9345-49DB7AF4D0F8}
inline constexpr ntl::wfp::filter_key<flow_layer_v6> flow_filter_key_v6{
    GUID{0xafc389e2,
         0xb315,
         0x488d,
         {0x93, 0x45, 0x49, 0xdb, 0x7a, 0xf4, 0xd0, 0xf8}}};

// {4197089C-DBE7-47C3-BD17-6EBE09616DC3}
inline constexpr ntl::wfp::filter_key<stream_layer_v6> stream_filter_key_v6{
    GUID{0x4197089c,
         0xdbe7,
         0x47c3,
         {0xbd, 0x17, 0x6e, 0xbe, 0x09, 0x61, 0x6d, 0xc3}}};
