...
EXTERN_C EXCEPTION_DISPOSITION __cdecl __C_specific_handler_noexcept(
    ...
    )
{
	...
	EXCEPTION_DISPOSITION Excption = __C_specific_handler( ExceptionRecord, EstablisherFrame, ContextRecord, DispatcherContext);
