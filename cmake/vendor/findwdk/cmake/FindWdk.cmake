...
string(FIND "${CMAKE_GENERATOR_PLATFORM}" "ARM" out)
if("${out}" EQUAL 0)
    set(WDK_ARM ON)
else()
    set(WDK_ARM OFF)
...
if (WDK_ARM)
    list(REMOVE_ITEM WDK_COMPILE_FLAGS "/Gz")
    if(CMAKE_SIZEOF_VOID_P EQUAL 4)
        list(APPEND WDK_COMPILE_DEFINITIONS "_ARM_;ARM;STD_CALL")
        set(WDK_PLATFORM "ARM")
    elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND WDK_COMPILE_DEFINITIONS "_ARM64;_ARM64_;ARM64;STD_CALL")
    ...
    if(CMAKE_SIZEOF_VOID_P EQUAL 4)
        list(APPEND WDK_COMPILE_DEFINITIONS "_X86_;i386;STD_CALL")
...
function(wdk_add_driver _target)
    ...
    if(CMAKE_SIZEOF_VOID_P EQUAL 4 AND NOT WDK_ARM)
        target_link_libraries(${_target} WDK::MEMCMP)
    endif()

    if(DEFINED WDK_CUSTOM_ENTRY_POINT)
        if(CMAKE_SIZEOF_VOID_P EQUAL 8 OR WDK_ARM)
