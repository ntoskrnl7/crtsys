...
| [KMDF helpers](./kmdf.md) | Optional `ntl::kmdf::main`, C++ contexts, typed I/O and hardware resources, idle/wake policy, DMA and USB, interrupt/timer/work-item, child-list, registry, and device-property facades |
