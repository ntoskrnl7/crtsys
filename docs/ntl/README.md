...
| [WFP helpers](./wfp.md) | Typed callout layers and decisions, safe connect redirection and proxy handoff, fragmented packet/stream views, bounded coroutine observation, flow contexts, injection ownership, and transactional dynamic policy |
...
| [HTTP and WebSocket protocol inspection](./protocol-inspection.md) | HTTP/1, WebSocket, HTTP/2/HPACK, HTTP/3/QPACK, content-coding, ALPN, ECH, pinning, mTLS, and fail-closed composition boundaries |
